                        ...
                        <div class="container-fluid">
                            <form action="save_schedule.php" method="post" id="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="date" class="form-control form-control-sm rounded-0" name="aptDate" id="aptDate" required>
                                </div>
                                <div class="form-group mb-2">
...
<?php 
$memberId = $conn->query("SELECT id FROM `users`");

// $schedules = $conn->query("SELECT * FROM `booking_list` WHERE `member_id` = '{$id}'");
