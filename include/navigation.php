        ...
        <div class="container-fluid">
            ...
            <div class ="collapse navbar-collapse" id="navMenu">
                <ul class ="navbar-nav mx-auto text-end">
                    ...
                    <li class ="nav-item px-2 py-2">
                        <a class ="nav-link text-uppercase text-dark" href="./../Appointment/appointment.php">
                            Appointment
                        </a>
                    </li>
                    <li class ="nav-item px-2 py-2">
                        <a class ="nav-link text-uppercase text-dark" href="./../Admin/Admin_Notification/Admin_notification.php">
                            Notification
                        </a>
                    </li>
                    <li class ="nav-item px-2 py-2">
